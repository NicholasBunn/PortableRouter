...
Hit **'Save and Apply'** to commit all of these updates and your Pi will now act as an additional router between your device and the router providing the internet! :) You can use the same process of connecting to networks when you move to new public networks from now on
